...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      ref={container}
      className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-black px-5 pb-8 pt-20 text-white sm:px-6 sm:pb-10 sm:pt-24 md:pt-28"
    >
      ...
      <div className="absolute left-5 top-5 z-20 hidden lg:block sm:left-7 sm:top-6 md:left-10 md:top-8">
        <img
          ...
          className="h-10 w-auto opacity-85 transition-opacity duration-300 hover:opacity-100 sm:h-12 md:h-14"
        />
      </div>
      ...
      <div className="z-10 mb-9 flex w-full flex-1 flex-col items-center justify-center text-center sm:mb-12 md:mb-14">
        <div className="hero-subtitle mb-4 sm:mb-5 md:mb-6">
          <div className="inline-flex border border-white/25 px-5 py-2 text-xs uppercase tracking-[0.12em] text-white/70 sm:text-sm">
            Portfolio in Progress...! please don't judge yet.
          </div>
        </div>

        <h1
          className="hero-title mb-6 flex gap-[0.02em] overflow-hidden py-2 text-[18vw] leading-[0.85] font-black uppercase italic text-white sm:mb-8 sm:text-[16vw] md:mb-10 md:text-[15vw]"
          style={{
        ...
        <p className="hero-subtitle mb-3 text-[11px] font-medium uppercase tracking-[0.18em] text-white/60 sm:mb-4 sm:text-sm sm:tracking-[0.24em] md:text-lg md:tracking-[0.3em]">
          I BUILD COOL THINGS FOR THE INTERNET
        </p>

        <p className="hero-highlight text-4xl font-serif italic text-white md:text-7xl md:tracking-wider sm:text-5xl">
      ...
      <div className="hero-scroll-cue absolute bottom-16 left-1/2 hidden -translate-x-1/2 items-center gap-3 text-[10px] uppercase tracking-[0.3em] text-white/45 sm:bottom-20 md:flex">
        <span>Scroll</span>
        <span className="block h-7 w-px bg-white/30" />
      </div>

      <div className="hero-footer-wrapper z-10 mt-auto flex w-full items-end justify-between gap-4 px-2 pb-4 text-[10px] font-semibold tracking-[0.12em] text-white/65 sm:px-12 sm:pb-8 sm:text-xs sm:tracking-wider md:text-sm">
        ...
        <div className="hero-footer hero-footer-right flex flex-col items-center sm:items-end">
          <div className="group relative flex cursor-default flex-col items-center gap-2 sm:items-end">
            <div className="relative flex items-center gap-4 overflow-hidden rounded-full border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent px-5 py-2.5 shadow-2xl backdrop-blur-xl transition-all duration-500 hover:border-gold/40 hover:bg-white/[0.06]">
              ...
              <div className="h-3.5 w-[1px] bg-white/[0.15]"></div>

              <span className="text-[10px] font-light uppercase tracking-[0.2em] text-gray-300 sm:text-xs">
                Engineer
              </span>
            </div>

            <div className="flex items-center space-x-3 text-[8px] uppercase tracking-[0.25em] text-gray-500 sm:pr-4 sm:text-[9px]">
